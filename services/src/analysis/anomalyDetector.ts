  ...
  try {
    ...
    if (
      ...
      anomalies.push({
        ...
        severity: 'medium',
        confidence: 0.6,
        description: 'Possible sandwich/MEV pattern detected: multiple program invocations around a swap',
        details: {
    ...
    if (
      ...
      anomalies.push({
        ...
        severity: 'medium',
        confidence: 0.7,
        description: 'Transaction failed after consuming compute units — possible nondeterministic behavior',
        details: {
